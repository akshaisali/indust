...
def preheating(request, sqf_type):
    # Placeholder view for preheating
    data = MaterialDetail.objects.filter(sqf_type=sqf_type)
    return render(request, 'records/preheating.html', {'data': data, 'sqf_type': sqf_type})
def traverser(request, sqf_type):
    # Placeholder view for Traverser
    data = MaterialDetail.objects.filter(sqf_type=sqf_type)
    return render(request, 'records/traverser.html', {'data': data, 'sqf_type': sqf_type})
